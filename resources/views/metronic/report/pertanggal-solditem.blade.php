...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ url('/oldapp/pertanggal') }}">Laporan</a>
                <i class="icon-angle-right"></i>
            </li>
            <li>
                <a href="{{ url('/oldapp/solditem') }}">Sold Item</a>
                <i class="icon-angle-right"></i>
            </li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{ url('/oldapp/report/pertanggal/solditem/print?tanggal='.$tanggal->format('Y-m-d')) }}"
